/***********************TO DO**************************
-Export Directions to txt File
-Output Values as intended (--Task X--,--Path X--,Change position of numbers in path printout)
-test against Automarker
...
#define TIME_STEP 64
#define MAP "C:\\Users\\JUni\\iCloudDrive\\University\\4.2\\MTRN4110\\Assignment\\Part B\\z1234567_MTRN4110_PhaseB\\M2.txt" //Main Computer
//#define MAP "C:\\Users\\banzi\\iCloudDrive\\University\\4.2\\MTRN4110\\Assignment\\Part B\\z1234567_MTRN4110_PhaseB\\Map.txt" //Laptop
...
int main(int argc, char** argv)
{
	...
	while (robot->step(TIME_STEP) != -1)
	{
		...
		//cout<<Heading<<" "<<Start[0]<<Start[1]<<endl;
		
		FloodFill(HorWall,VertWall,Cells);
		PathFinder2(HorWall,VertWall,Cells,Start,Heading);

	
		//PathPrinter(Cells,Path,Start);
		//------------------------------------------
		/*for (int i = 0; i < 6; i++)
		{
			for (int j = 0; j < 9; j++)
